...
class TimetablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create timetable" do
    assert_difference("Timetable.count") do
      post timetables_url, params: { timetable: { date: @timetable.date, subject: @timetable.subject, time: @timetable.time } }
    end
  ...
  test "should update timetable" do
    patch timetable_url(@timetable), params: { timetable: { date: @timetable.date, subject: @timetable.subject, time: @timetable.time } }
